...
py_script="scripts/train_continuous_tokenizer.py"
config="configs/train_continuous.yaml"
...
job_id=${SLURM_JOB_ID}
output_file="${output_dir}/cosmos__${current_date}__${job_id}__train_full.out"
